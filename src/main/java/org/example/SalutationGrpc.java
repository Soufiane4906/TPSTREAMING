...
public final class SalutationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.SalutationOuterClass.SalutRequest,
      org.example.SalutationOuterClass.SalutResponse> getMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "message",
      requestType = org.example.SalutationOuterClass.SalutRequest.class,
      responseType = org.example.SalutationOuterClass.SalutResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<org.example.SalutationOuterClass.SalutRequest,
      org.example.SalutationOuterClass.SalutResponse> getMessageMethod() {
    io.grpc.MethodDescriptor<org.example.SalutationOuterClass.SalutRequest, org.example.SalutationOuterClass.SalutResponse> getMessageMethod;
      ...
      synchronized (SalutationGrpc.class) {
        if ((getMessageMethod = SalutationGrpc.getMessageMethod) == null) {
          SalutationGrpc.getMessageMethod = getMessageMethod = 
              io.grpc.MethodDescriptor.<org.example.SalutationOuterClass.SalutRequest, org.example.SalutationOuterClass.SalutResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Salutation", "message"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.SalutationOuterClass.SalutRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.SalutationOuterClass.SalutResponse.getDefaultInstance()))
  ...
  public static abstract class SalutationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<org.example.SalutationOuterClass.SalutRequest> message(
        io.grpc.stub.StreamObserver<org.example.SalutationOuterClass.SalutResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                org.example.SalutationOuterClass.SalutRequest,
                org.example.SalutationOuterClass.SalutResponse>(
  ...
  private static abstract class SalutationBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.SalutationOuterClass.getDescriptor();
    }
